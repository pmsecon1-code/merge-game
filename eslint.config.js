    ...
    },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                SPECIAL_QUEST_REWARD_COINS: 'readonly',
                GRID_COLS: 'readonly',
                GRID_ROWS: 'readonly',
                CATS: 'readonly',
                DOGS: 'readonly',
                ...
                ROULETTE_COLORS: 'readonly',
                SNACK_CHANCE: 'readonly',
                ANIMAL_HP_DECAY: 'readonly',
                ANIMAL_HP_DECAY_SEC: 'readonly',
                ...
                apartmentState: 'writable',
                shopItems: 'writable',
                coins: 'writable',
                cumulativeCoins: 'writable',
                nextSpecialTarget: 'writable',
                currentSetRescues: 'writable',
                diamonds: 'writable',
                energy: 'writable',
                ...
                genLevels: 'writable',
                dragData: 'writable',
                currentRouletteRoom: 'writable',
                isSpinning: 'writable',
                currentRotation: 'writable',
                ...
                cumulativeBar: 'writable',
                cumulativeText: 'writable',
                rescueText: 'writable',
                rescueTimerEl: 'writable',
                shopTimerBadge: 'writable',
                rouletteWheel: 'writable',
                ...
                lastRaceDate: 'writable',
                todayRaceCount: 'writable',
                raceWins: 'writable',
                raceLosses: 'writable',
                ...
                addPmProgress: 'readonly',
                updatePmUI: 'readonly',
                checkAutoCompleteMissions: 'readonly',
                updateSpecialQuestUI: 'readonly',
                giveSpecialReward: 'readonly',
                updateRescueQuestUI: 'readonly',
                startShopTimer: 'readonly',
                refreshShop: 'readonly',
                generateRandomShopItem: 'readonly',
                renderShop: 'readonly',
                buyShopItem: 'readonly',
                initApartment: 'readonly',
                startAnimalHPTimer: 'readonly',
                showHelpBubble: 'readonly',
                renderApartment: 'readonly',
                openRoulette: 'readonly',
                renderRouletteLabels: 'readonly',
                updateRoulettePopupUI: 'readonly',
                startSpin: 'readonly',
                finishSpin: 'readonly',
                ...
                // race.js globals
                RACE_GOAL: 'readonly',
                RACE_MAX_PER_DAY: 'readonly',
                RACE_CODE_EXPIRE_MS: 'readonly',
                ...
                canJoinRace: 'readonly',
                getNextMidnightUTC: 'readonly',
                checkRaceReset: 'readonly',
                updateRaceUI: 'readonly',
                updateRaceUIFromData: 'readonly',
                formatRaceTimer: 'readonly',
                openRaceInvitePopup: 'readonly',
