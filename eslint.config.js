    ...
    },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                SPECIAL_UPGRADE_COST: 'readonly',
                SPECIAL_COOLDOWNS: 'readonly',
                getSpecialCooldown: 'readonly',
                CAGE_MAX_LEVEL: 'readonly',
                GRID_COLS: 'readonly',
                BOARD_MISSION_START: 'readonly',
                // 주사위 여행 상수
                ...
                QUEST_PIGGY_CHANCE: 'readonly',
                QUEST_MULTI_BASE_CHANCE: 'readonly',
                QUEST_MULTI_LEVEL_FACTOR: 'readonly',
                QUEST_MULTI_MAX_CHANCE: 'readonly',
                ...
                EXPLORE_BASE_COST: 'readonly',
                EXPLORE_COST_INCREMENT: 'readonly',
                EXPLORE_FOSSILS: 'readonly',
                EXPLORE_MILESTONES: 'readonly',
                EXPLORE_MAP: 'readonly',
                getExploreCost: 'readonly',
                getExploreAdjacentTiles: 'readonly',
                DINOSAURS: 'readonly',
                ...
                migrateEnergyRecovery: 'readonly',
                loadDailyMissions: 'readonly',
                loadStoryProgress: 'readonly',
                cleanupLegacyItems: 'readonly',
                ...
                spawnItem: 'readonly',
                spawnToy: 'readonly',
                handleLockedCell: 'readonly',
                handleMissionCell: 'readonly',
                handleSpecialItem: 'readonly',
                ...
                adEnergy: 'readonly',
                confirmAd: 'readonly',
                openCooldownPopup: 'readonly',
                confirmCooldownReset: 'readonly',
                ...
                renderExploreModal: 'readonly',
                closeExploreModal: 'readonly',
                // 주사위 여행 함수
                tryDropDice: 'readonly',
                useDice: 'readonly',
                rollDice: 'readonly',
                executeMove: 'readonly',
                closeDiceRollPopup: 'readonly',
                ...
                musicEnabled: 'writable',
                audioUnlocked: 'writable',
                initSound: 'readonly',
                unlockAudio: 'readonly',
                createSynthSound: 'readonly',
                playSound: 'readonly',
                playBGM: 'readonly',
                stopBGM: 'readonly',
                toggleSound: 'readonly',
                toggleMusic: 'readonly',
                updateSoundUI: 'readonly',
                bgmTimer: 'writable',
                // story.js globals
                STORY_IMAGES: 'readonly',
                STORY_UNLOCK_LEVEL: 'readonly',
                STORY_BOSS_HP_BASE: 'readonly',
                storyProgress: 'writable',
                storySlides: 'writable',
                storySlideIdx: 'writable',
                storySlideOnClose: 'writable',
                getBossHpColor: 'readonly',
                getNextStoryImage: 'readonly',
                checkStoryQuests: 'readonly',
                activateImageQuest: 'readonly',
                completeImageQuest: 'readonly',
                spawnBossOnBoard: 'readonly',
                trySpawnPendingBoss: 'readonly',
                ...
                closeStoryPopup: 'readonly',
                openStoryGallery: 'readonly',
                renderStoryGallery: 'readonly',
                viewStoryImage: 'readonly',
                updateStoryUI: 'readonly',
                // tutorial.js globals
                TUTORIAL_STEPS: 'readonly',
                startTutorial: 'readonly',
                showTutorialStep: 'readonly',
                advanceTutorial: 'readonly',
                completeTutorial: 'readonly',
                isTutorialClickAllowed: 'readonly',
                findSameLevelPair: 'readonly',
                findReadyQuestBtn: 'readonly',
                repositionTutorial: 'readonly',
                // ui.js globals
                renderGrid: 'readonly',
                createItem: 'readonly',
                updateAll: 'readonly',
