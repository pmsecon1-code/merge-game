...
css/styles.css      # 전체 스타일 (~1870줄)
js/constants.js     # 상수/데이터 (~498줄)
js/state.js         # 전역 변수 (~118줄)
js/auth.js          # 인증/세션/회원탈퇴 (~177줄)
js/save.js          # 저장/로드 (~564줄)
js/game.js          # 게임 로직 (~843줄)
js/systems.js       # 미션/주사위여행/상점 (~476줄)
js/album.js         # 앨범 시스템 (~248줄)
js/race.js          # 레이스 시스템 (~1068줄)
js/sound.js         # 사운드 (효과음+BGM) (~410줄)
js/tutorial.js      # 온보딩 튜토리얼 (~194줄)
js/ui.js            # UI/렌더링/배지바/설정 (~708줄)
js/main.js          # 초기화 (~268줄)
